...
Целта на овој блог е да научиме како функционира <b>Transformer</b> архитектурата, делот кој ја направи науката за неуронски мрежи посериозна, практична и достапна за секого, се користи во Large Language Models како GPT, Claude, Mistral, LLAMA...
