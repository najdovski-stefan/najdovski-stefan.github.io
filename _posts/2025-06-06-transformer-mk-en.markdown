...
Целта на овој блог е да научиме како функционира <b>Transformer</b> архитектурата, делот кој ја направи науката за неуронски мрежи посериозна, се користи во Large Language Models како GPT, Claude, Mistral, LLAMA...

На крајот има и <b>"demo"</b> од проектот, што може да се користи практично.

Секако нашата имплементација тука ќе биде <b>многу пати поедноставна </b>, но есенцијално идејата позади е иста, скоро целосно базирана врз оригиналниот труд [Attention is All You Need](https://arxiv.org/pdf/1706.03762).
